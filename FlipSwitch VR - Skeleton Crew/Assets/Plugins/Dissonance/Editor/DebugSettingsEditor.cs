...
namespace Dissonance.Editor
{
    ...
    public class DebugSettingsEditor : UnityEditor.Editor
    {
        ...
        private static void DrawNetworkSettings(DebugSettings settings)
        {
        ...
        private static void DrawPlaybackSettings(DebugSettings settings)
        {
        ...
        private void DrawLogSettings(DebugSettings settings)
        {
        ...
        [MenuItem("Window/Dissonance/Diagnostic Settings")]
