...
namespace Dissonance
{
        ...
        where TId : IEquatable<TId>
    {
        ...
        /// <returns></returns>
        public T Open(TId id, bool positional = false, ChannelPriority priority = ChannelPriority.Default, float amplitudeMultiplier = 1)
        {
            ...
            if (_openChannelsBySubId.Count >= ushort.MaxValue)
                throw Log.CreatePossibleBugException("Attempted to open 65535 channels", "7564ECCA-73C2-4720-B4C0-B873E63216AD");
