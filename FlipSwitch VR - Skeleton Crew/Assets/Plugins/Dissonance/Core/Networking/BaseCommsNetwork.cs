...
namespace Dissonance.Networking
{
        ...
        where TClient: BaseClient<TServer, TClient, TPeer>
    {
        ...
        void ICommsNetwork.Initialize(string playerName, Rooms rooms, PlayerChannels playerChannels, RoomChannels roomChannels)
        {
            if (playerName == null)
        ...
        public void OnInspectorGui()
        {
            ...
            try
            {
                ...
                if (Client != null)
                {
                    ...
                    EditorGUILayout.LabelField("Client To Client", Client.SentPeerTraffic.ToString());
                }
