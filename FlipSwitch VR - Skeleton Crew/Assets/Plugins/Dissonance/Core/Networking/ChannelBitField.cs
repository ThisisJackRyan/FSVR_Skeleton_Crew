...
namespace Dissonance.Networking
{
    ...
    {
        private const ushort TypeMask = 0x0001;         //00000001
        private const ushort PositionalMask = 0x0002;   //00000010
        private const ushort ClosureMask = 0x0004;      //00000100

        private const ushort PriorityOffset = 3;
        private const ushort PriorityMask = 0x0018;     //00011000

        private const ushort SessionIdOffset = 5;
        private const ushort SessionIdMask = 0x0061;    //01100000

        private const ushort AmplitudeOffset = 8;
        private const ushort AmplitudeMask = 0xFF00;    //01100000
